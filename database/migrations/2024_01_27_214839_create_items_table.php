...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('items', function (Blueprint $table) {
            ...
            $table->enum('payment_status', ['Pending Payment', 'Customer Paid', 'Payment Sent', 'Payment cancelled'])->index('items_payment_status_idx')->default('Pending Payment');
            $table->enum('shipping_status', ['Package Ready', 'Pending Shipping', 'Shipped', 'Delivered'])->index('items_shipping_status_idx')->default('Pending Shipping');
