...
<div>
    ...
    <div class="flex justify-between items-center xl:w-2/3 m-auto">
        ...
        <div class="p-4 font-semibold text-xl">
            ...
            <input type="date" name="start_date" class="text-rust-orange caret-rust-orange">
        </div>
        <div class="p-4 font-semibold text-xl">
            <!-- date -->
            <label for="end_date" class="text-white">End Date:</label>
            <input type="date" name="end_date" class="text-rust-orange caret-rust-orange">
        </div>
    </div>
    ...
    <div class="flex justify-center items-center xl:w-2/3 m-auto">
        <div class="p-4 font-semibold text-xl">
            <section>
                <select name="status" id="status" class="bg-sky-blue text-black text-lg border-2 w-full p-2 rounded-lg">
